...
#include "wfasclient.h"

#define SIZE (1024)

WfasClient::WfasClient() : SurfaceFetch()
{
    xRes = 30.0;
    yRes = 30.0;
    northeast_x = -40;
...
*/
const char * WfasClient::ReplaceSRS( int nEpsgCode, const char *pszUrl )
{
    int i, n;
...
WfasClient::~WfasClient()
{
}

SURF_FETCH_E WfasClient::FetchBoundingBox( double *bbox, double resolution,
                                               const char *filename,
                                               char **options )
{
    (void)resolution;
